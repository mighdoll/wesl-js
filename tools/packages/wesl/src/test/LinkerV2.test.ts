/**
 * Linker tests running with V2 parser
 *
 * This file tests basic linking scenarios using the V2 custom parser instead of V1.
 * It runs the same tests as Linker.test.ts but with weslParserConfig.useV2Parser = true.
 *
 * Purpose: Integration testing to validate V2 parser works end-to-end on basic linking
 */
