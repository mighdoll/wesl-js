...
A Vite-powered TypeScript application for visualizing benchmark data with interactive charts.
...
- 🔄 **Auto-refresh** - Automatically updates when benchmark data changes
...
- **File Polling** - Watches JSON file for changes and auto-refreshes
...
- Percentiles (P75, P99)
- Execution metadata (iterations, total time)
